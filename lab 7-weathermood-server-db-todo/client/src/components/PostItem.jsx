      ...
      <div className="post-item d-flex flex-column" onClick={this.handleClick}>
        ...
        <div className="vote d-flex justify-content-end">
          <div className="vote-results">
            {clearVotes > 0 && (
              <span>
                <i className={getMoodIcon('Clear')}></i>&nbsp;{clearVotes}
                &nbsp;&nbsp;
              </span>
            )}
            {cloudsVotes > 0 && (
              <span>
                <i className={getMoodIcon('Clouds')}></i>&nbsp;{cloudsVotes}
                &nbsp;&nbsp;
              </span>
            )}
            {drizzleVotes > 0 && (
              <span>
                <i className={getMoodIcon('Drizzle')}></i>&nbsp;{drizzleVotes}
                &nbsp;&nbsp;
              </span>
            )}
            {rainVotes > 0 && (
              <span>
                <i className={getMoodIcon('Rain')}></i>&nbsp;{rainVotes}
                &nbsp;&nbsp;
              </span>
            )}
            {thunderVotes > 0 && (
              <span>
                <i className={getMoodIcon('Thunder')}></i>&nbsp;{thunderVotes}
                &nbsp;&nbsp;
              </span>
            )}
            {snowVotes > 0 && (
              <span>
                <i className={getMoodIcon('Snow')}></i>&nbsp;{snowVotes}
                &nbsp;&nbsp;
              </span>
            )}
            {windyVotes > 0 && (
              <span>
                <i className={getMoodIcon('Windy')}></i>&nbsp;{windyVotes}
                &nbsp;&nbsp;
              </span>
            )}
          </div>
