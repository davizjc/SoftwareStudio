...
export default class Forecast extends React.Component {
  ...
  constructor(props) {
    ...
    this.listMoreTodos = this.listMoreTodos.bind(this);
  }
  ...
  render() {
    ...
    document.querySelector('.weather-bg .mask').className = `mask ${
      masking ? 'masking' : ''
    }`;
      ...
      <div className="forecast">
        ...
        <div className="todos">
          <div className="label d-flex justify-content-between align-items-end">
            <h4>
              <i className="fa fa-tags" aria-hidden="true"></i>&nbsp;&nbsp;Todos
            </h4>
            <div>
              <Input
                type="checkbox"
          ...
          <TodoList
            ...
            listMoreTodos={this.listMoreTodos}
  ...
  listTodos(searchText) {
    ...
    listTodosFromApi(this.state.unaccomplishedOnly, searchText)
      .then((todos) => {
        this.setState({
          todos,
          todoLoading: false,
